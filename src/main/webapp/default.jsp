...
<html>
  <head>
    ...
    <title>Does it have snakes or latha?</title>
  </head>
  ...
  <body>
    ...
    <div id="hate" class="container snakes snake-hater">
      <h1 class="cover-heading">Does it have snakes and rabbits ans?   LATHANGI OR SIVANI</h1>
      ...
      <!--Browse movies -->
      <h2>Find something to watch for latha</h2>
      ...
      <!--Search for a movie -->
      <h2>Already got a movie in mind sita ramam?</h2>
